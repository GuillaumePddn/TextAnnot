 ...
 * The stemmer has been slightly modified by Axel Reymonet in order to recognize more suffixes.
 */

public class CustomFrenchStemmer {
	 ...
	 */
	private void step1( ) {
		String[] suffix = { "ages", "ances", "iqUes", "ismes", "ables", "istes", "age", "ance", "iqUe", "isme", "able", "iste" };
	...
	private boolean step2a() {
		String[] search = { "îmes", "îtes", "iraIent", "irait", "irais", "irai", "iras", "ira",
							...
							"isses", "isse", "ir", "is", "ît", "it", "ies", "ie", "i","ent","eur","ations","ation" };//test AXEL: ENT, EUR, ATION
...
public static void main (String args[]) throws IOException
{
	...
	while (true)
	{
		System.out.print("Enter word to stem: ");
		BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
		String msg = in.readLine();
		System.out.println(msg+" => "+stemmer.stem(msg));
	}
}
}